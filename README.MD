...
The focus of this assignment is on writing the code to implement a given communication protocol between the server and the client, specifically two goals:
...
as clear text in the server storage.
...
I will also visually inspect your code. I reserve the right to deduct points 
for especially poorly written code.  In particular, if you decide to move functions 
between files, or add files, or do other things that break the scripts in the grading 
folder, then you will lose at least 10%.
...
You may work in teams of 2 for this assignment.  If you are working in a team, you will be prompted to create a team on Github (name the team as p1-lehigh-username1-lehigh-username2). Working in a team means you should **pair program** for the entire assignment.  After all, your goal is to learn together, not to each learn half the material.
...
generative AI tools to help you write code for this assignment.
...
You should be done with this assignment before 11:59 PM on February 16th, 2026.
